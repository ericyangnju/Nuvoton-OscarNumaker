...
void I2C_WAIT_READY_M(I2C_T *i2c)
{
...
I2C_WAIT_READY_M(MPU6050_I2C_PORT);
if(I2CFail==1)goto I2C_SingleWrite_Fail;
...
I2CFail=0;
	      ...
	      //I2C_WAIT_READY(MPU6050_I2C_PORT);
I2C_WAIT_READY_M(MPU6050_I2C_PORT);
if(I2CFail==1)goto I2C_SingleRead_Fail;
        MPU6050_I2C_PORT->CTL |= I2C_CTL_SI_Msk;   //clear flag		
